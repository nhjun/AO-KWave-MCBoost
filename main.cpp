...
//    
//    /* ----------------------------------------------------------------------------------------------------
//     * Add attributes to the medium for the monte-carlo simulation.
//     */
...
//    
//	double start_depth = 0.0f;
//	double end_depth = tissue->getZbound();
//	Layer *tissueLayer0 = new Layer(mu_a, mu_s, refractive_index, anisotropy, start_depth, end_depth);
//
//    
//    // Create a circular detector that serves as a way to detect photons that leave through an exit aperture.
//	//
//	Detector *detector;
//	CircularDetector circularExitDetector(0.005f, Vector3d(tissue->getXbound()/2,
//                                                           tissue->getYbound()/2,
//                                                           tissue->getZbound()));
...
//    
//    /* ----------------------------------------------------------------------------------------------------
//     * Define the location where light is injected into the medium.
//     */
//    coords LaserInjectionCoords;
//	LaserInjectionCoords.x = tissue->getXbound()/2; // Centered
//	LaserInjectionCoords.y = tissue->getYbound()/2; // Centered
//	LaserInjectionCoords.z = 1e-15f;   // Just below the surface of the 'air' layer.
//
//    
//    
//    
//    /* ----------------------------------------------------------------------------------------------------
//     * Finish construction of the monte-carlo simulation object.
//     */
//    MC_Boost da_boost;
//    da_boost.Set_num_threads(2);
//    da_boost.Set_num_photons(10000);
//    
//
//    /* ----------------------------------------------------------------------------------------------------
//     * Run the simulation and save seeds that produced paths that made their way through the exit aperture.
//     */
//    da_boost.Generate_RNG_seeds(tissue, LaserInjectionCoords);
//    da_boost.Load_exit_RNG_seeds();
    ...
    //AO_simulation.Set_num_MC_threads(1);
    AO_simulation.Set_num_MC_threads(boost::thread::hardware_concurrency());
    AO_simulation.Set_num_photons(1e3);
...
//    }
    // ----------------------------------------------------------------------------------
    // end Acousto-Optic simulation
    
    
//    KSpaceSolver.PostCompute();
//    
//    
//    
//    
...
//    
//    Medium *tissue = new Medium(Nx*dx,
//                                Ny*dy,
//                                Nz*dz);
//    
//    
