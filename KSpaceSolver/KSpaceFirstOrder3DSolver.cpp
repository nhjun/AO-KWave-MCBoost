...
/**
 * This method "pre" computes k-space First Order 3D simulation.
 * It launches calculation for
 * FFT initialization, pre-processing.
 *
 */
void TKSpaceFirstOrder3DSolver::PreCompute(){
...
/**
 * This method "post" computes k-space First Order 3D simulation.
 * It launches calculation for
 * Printing, Writing data to disk, etc.
 *
 */
void TKSpaceFirstOrder3DSolver::PostCompute(){
...
void TKSpaceFirstOrder3DSolver::PrintFullNameCodeAndLicense(FILE * file){
    fprintf(file,"\n");
    fprintf(file,"+--------------------------------------------------+\n");
    fprintf(file,"| Build Number:     kspaceFirstOrder3D v2.13       |\n");
