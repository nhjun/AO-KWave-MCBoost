...
%
% This example demonstrates iterative improvement for photoacoustic image
% reconstruction. It applies a positvity condition at each iteration. The
% part of the image within the region satisfying the 'visibility
% (audibility) condition' can be recovered exactly, given sufficient
% iterations. 
%
% author: Ben Cox
